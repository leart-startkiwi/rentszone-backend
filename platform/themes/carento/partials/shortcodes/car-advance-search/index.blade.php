            ...
            <div class="box-search-advance background-card wow fadeIn">
                <div class="box-top-search">
                    <div class="left-top-search">
                        ...
                        @php
                            $categoryLinkStyle = ['category-link', 'text-sm-bold', 'btn-click'];
                        @endphp
                        @if (count($tabs) > 1)
                        ...
                        <div class="item-search" id="pick-up-location">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="px-3 py-2">
                                        <input type="text" class="form-control dropdown-search-input" placeholder="{{ __('Search location...') }}">
                                    </li>
...
<script>
    ...
    document.querySelectorAll('.dropdown-menu a.dropdown-item').forEach(item => {
        item.addEventListener('click', function (e) {
            ...
            const buttonLabel = dropdown.querySelector('button span');
