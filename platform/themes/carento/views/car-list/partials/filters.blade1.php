 ...
 @if($carBookingLocations->isNotEmpty())
    ...
    <form method="GET" action="{{ request()->url() }}" id="filter-form">
        <div class="sidebar-left border-1 background-body">
            <div class="box-filters-sidebar">
                <div class="block-filter border-1">
                    <h6 class="text-lg-bold item-collapse neutral-1000">{{ __('Price per day') }}</h6>
                    <div class="box-collapse scrollFilter">
                        <div class="pt-20">
                            <div class="box-value-price">
                                <input type="number"
                                       ...
                                       value="{{ request()->query('rental_rate') ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const input = document.querySelector('input[name="rental_rate"]');
